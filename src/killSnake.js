var KillSnake = function(top, left, timeBetweenSteps) {
  ...
  this.$node = $('<span class="babydancer"> <img id="image" src="http://www.animatedimages.org/data/media/290/animated-snake-image-0008.gif" alt="Crying baby lost in the cave" height="100" width="100"> </span>');
